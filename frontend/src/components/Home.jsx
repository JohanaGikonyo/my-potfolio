          ...
          <div className="flex flex-row">
            <p>
              <span className="flex items-center">
                ...
                talking to your grandchildren many years from now, be sure you have a good story to tell.
                <BiSolidQuoteSingleRight />
              </span>
            </p>
          </div>
          ...
          <div className="flex flex-row">
            <p>
              <span className="flex items-center">
                ...
                for something that has happened ... it`s normal. That is what is going to happen to you in life. No one
                gets through unscathed. We are all going to have a few scratches on us. Please be kind to yourselves and
          ...
          <div className="flex flex-row">
            <p>
              <span className="flex items-center">
                {" "}
                <BiSolidQuoteSingleLeft />
                For me, becoming isn`t about arriving somewhere or achieving a certain aim. I see it instead as forward
                motion, a means of evolving, a way to reach continuously toward a better self. The journey doesn`t end.
                <BiSolidQuoteSingleRight />
              </span>
            </p>
          </div>
